({
    ...
    onSelectChange : function(component, event, helper){
        ...
        var selectedObject = component.find('selectObject').get('v.value'); //'Accont'; //
        console.log('-selectedObject-->'+selectedObject);
        var getFieldSet = component.get('c.getFieldSet'); //'AccountForm'; //
    ...
    onInit : function(component, event, helper){
        var self = this;
        var selectedObject = 'Account'; //component.find('selectObject').get('v.value'); //'Account'; //
        var selectedfieldSet = 'AccountForm'; //component.find('fieldSet').get('v.value'); //'AccountForm'; //
        console.log('--selectedObject--'+selectedObject);
        console.log('--selectedfieldSet--'+selectedfieldSet);
        ...
        FiledSetMember.setCallback(this, function(response){
            var state = response.getState();
            //console.log('getFieldSetMember--state--'+state);
            //console.log('getFieldSetMember--response.getReturnValue()--'+response.getReturnValue());
                            ...
                            function(components, status, errorMessage){
                                if (status === "SUCCESS") {
                                    ...
                                    for(var j=0; j < components.length; j++){
                                        ...
                                        //console.log('--label--'+components[j].config.attributes.label);
                                        //console.log('--name--'+components[j].config.attributes.name);
                                        console.log('--components[j]--'+components[j]);
